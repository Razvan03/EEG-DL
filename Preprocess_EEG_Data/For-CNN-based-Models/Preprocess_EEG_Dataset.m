...
for i = 1:num_channel
    Dataset = ['10-SubjectsDataset_', num2str(i), '.mat'];
...
Labels = load('10-SubjectsLabels_1.mat');
...
%% Save the data using the save_data_in_chunks function
save_data_in_chunks('training_set', training_set);
save_data_in_chunks('test_set', test_set);
save_data_in_chunks('training_label', training_label);
save_data_in_chunks('test_label', test_label);
save_data_in_chunks('all_data', all_data);
save_data_in_chunks('all_labels', all_labels);